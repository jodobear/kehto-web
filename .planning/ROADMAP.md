...
- [x] **Phase 102: Paja Standard-NAP Social PoC** - Make Paja expose login-bound identity, follows, and followed kind-0 profiles through normal identity/outbox behavior.
...
- [x] 103-01-PLAN.md — Prove one standard upload-to-verified-resource browser tracer after fail-closed Phase 102 and pinned-spec preflight.

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 103-02-PLAN.md — Harden BUD-11 transport, terminal upload lifecycle, teardown fencing, and upload/resource ACL denial.

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 103-03-PLAN.md — Expand the tracer into configured ordered replicas, tuple-scoped consent, safe policy defaults, and cancellation-safe diagnostics.

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 103-04-PLAN.md — Prove ordered replicas, mediated preview, cancellation truth, and authority absence in the real opaque iframe.
- [x] 103-05-PLAN.md — Synchronize Paja documentation, public contracts, and focused Paja/services changesets.
