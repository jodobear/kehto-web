...
- [x] **v1.15: Address AI Slop** - 5 phases (68-72), 20/20 original requirements complete, local `aislop` scan no longer Critical, 563 unit tests green ([archive](v1.15-ROADMAP.md) | [requirements](v1.15-REQUIREMENTS.md) | [audit](v1.15-MILESTONE-AUDIT.md))
- [x] **v1.16: Structural Code Quality Refactor** - 4 phases (73-76), 18/18 requirements, local `aislop` scan clean, 563 unit tests green ([archive](v1.16-ROADMAP.md) | [requirements](v1.16-REQUIREMENTS.md) | [audit](v1.16-MILESTONE-AUDIT.md))
- [x] **v1.17: Beautify the SPA Landing Page** - 3 phases (77-79), 15/15 requirements, static `/web/` brand system, GSAP motion, liquid accent, and visual proof ([archive](v1.17-ROADMAP.md) | [requirements](v1.17-REQUIREMENTS.md) | [audit](v1.17-MILESTONE-AUDIT.md))
...
- [x] **v1.19: NAP Ontology Alignment** - 1 phase (83), 8 requirements ([archive](v1.19-ROADMAP.md) | [requirements](v1.19-REQUIREMENTS.md))
...
- [x] **v1.29: Napplet Convention and Runtime Conformance** - 6/6 phases complete (101-106), 47 plans, 89 tasks, 54 requirements, corrective PR #220 and Version Packages PR #221 merged, eight-package Napplet-0.31-compatible npm/JSR release published and downstream-verified; archived 2026-07-31
